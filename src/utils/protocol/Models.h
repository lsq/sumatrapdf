...
inline const FieldInfo gFileMetadataFileds[] = {
    ...
    {offsetof(FileMetadata, fileType), SettingType::String, (intptr_t)"application/octet-stream"},
...
inline const StructInfo gFileMetadataInfo = {
    ...
    "Id\0FileName\0Size\0FileTyp\0Sha256\0Preview\0Modified\0Accessed\0LocalPath"};
